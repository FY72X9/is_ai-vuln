...
> God node · 10 connections · [D:\Codes\research_banks\is_ai-vuln\src\models\deep_tabular.py](file:///D:/Codes/research_banks/is_ai-vuln/src/models/deep_tabular.py#L16)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as MambularSSMIDS
...
### rationale_for
- [[Mambular State Space Model (SSM) for Tabular Intrusion Detection.          Exhib]] `EXTRACTED`
