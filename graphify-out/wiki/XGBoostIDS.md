...
> God node · 11 connections · [D:\Codes\research_banks\is_ai-vuln\src\models\classical.py](file:///D:/Codes/research_banks/is_ai-vuln/src/models/classical.py#L16)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as XGBoostIDS
    participant P1 as BaseIDSModel
    participant P2 as Visualization and journal-grade layouting modules.
    participant P3 as LightGBMIDS
...
### rationale_for
- [[XGBoost Classifier Baseline with Optuna Tuning and Hist/GPU acceleration.]] `EXTRACTED`
