...
> God node · 10 connections · [D:\Codes\research_banks\is_ai-vuln\src\models\deep_tabular.py](file:///D:/Codes/research_banks/is_ai-vuln/src/models/deep_tabular.py#L131)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as FTTransformerIDS
...
### rationale_for
- [[Feature Tokenizer Transformer (FT-Transformer) for Tabular IDS.          Impleme]] `EXTRACTED`
